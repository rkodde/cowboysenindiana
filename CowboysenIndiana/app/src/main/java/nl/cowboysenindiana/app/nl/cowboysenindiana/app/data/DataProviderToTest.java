...
public class DataProviderToTest {
    ...
    static {
        ...
        data.add(new ChildToTest(10101, "Digital Character",
        ...
        data.add(new ChildToTest(10102, "Designing a Basic"
        ...
        data.add(new ChildToTest(10103, "Animating in 2D"
        ...
        data.add(new ChildToTest(10104, "Creating a Flash Game"
        ...
        data.add(new ChildToTest(20101, "Figure Drawing I"
        ...
        data.add(new ChildToTest(20102, "Figure Drawing II"
        ...
        data.add(new ChildToTest(20103, "Architectural Drawing"
        ...
        data.add(new ChildToTest(30101, "Pattern Making"
        ...
        data.add(new ChildToTest(30102, "Garment Construction I"
        ...
        data.add(new ChildToTest(30103, "Garment Construction II"
        ...
        data.add(new ChildToTest(30104, "Textile Design"
        ...
        data.add(new ChildToTest(40101, "Typography for Graphic"
        ...
        data.add(new ChildToTest(40102, "Principles of Interface"
        ...
        data.add(new ChildToTest(50101, "Music Theory"
        ...
        data.add(new ChildToTest(50102, "Music Production"
        ...
        data.add(new ChildToTest(60101, "Photography Workshop I"
        ...
        data.add(new ChildToTest(60102, "Photography Workshop II"
        ...
        data.add(new ChildToTest(60103, "Photography Hands",
